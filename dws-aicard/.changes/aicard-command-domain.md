...
- Inline Base64 images produce `resource.base64_image_unverified` warnings as a new diagnostic relative to master. Malformed resources still fail. Preview results retain preflight diagnostics; successful validation does not certify client image support.
